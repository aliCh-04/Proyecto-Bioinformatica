...
def ejecutar_experimentos():
    ...
    metricas["metodo"] = "propio"

    resultados.append(metricas)

    print("Procesando resultados de Velvet")
    velvet_fasta = f"{CARPETA_RESULTADOS}/contigs.fa"

    longitudes = leer_longitudes_fasta(velvet_fasta)
    metricas = calcular_metricas(longitudes)

    metricas["k"] = 31
    metricas["tiempo"] = 170.072  
    metricas["metodo"] = "velvet"
...
def guardar_csv(resultados):
    ...
    with open(ruta_csv, "w", newline="") as f:
        campos = ["k", "num_contigs", "longitud_maxima", "longitud_total", "n50", "tiempo", "metodo"]
...
def main():
    ...
    metodos, n50s, num_contigs, max_contigs, long_total, tiempos = leer_resultados(RUTA_RESULTADOS)
